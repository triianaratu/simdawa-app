        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Perbaharui Persyaratan Beasiswa </h2>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <label for="nama_persyaratan" class="col-md-2">Persyaratan Beasiswa</label>
                                <div class="col-md-10">
                                    <input type="text" name="nama_persyaratan" required placeholder="Persyaratan Beasiswa" value="<?= $persyaratan->nama_persyaratan ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
