                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <label for="nama_jenis" class="col-md-2">Jenis Beasiswa</label>
                                <div class="col-md-10">
                                    <input type="text" name="nama_jenis" required placeholder="Jenis Beasiswa" value="<?= $jenis->nama_jenis ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
